...
**ARCHIVE NOTICE**: This repo is no longer maintained. I have personally switched to running the splashtop-business Linux client with [Distrobox](https://distrobox.it/) in a Debian 13 container. This has been working decently enough for me, and it also runs correctly with Wayland. Feel free to fork this if you'd like.
...
The application runs but is unstable. It's hard to tell how much of this is due to issues with the Flatpack packaging and how much is from the app being buggy. They haven't put very much effort into the Linux build.
